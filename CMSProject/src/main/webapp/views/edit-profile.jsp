...
<br>
           <form id ="des" action="Edituser" method="post">
            ...
            <div class="form-group">
                <label class="labeltext"> First Name</label> <br>
               
                <input size ="50"  maxlength= "30"  type ="Text" class="form-control" name="firstname"  placeholder="Enter the first name"/>
                <span class="text-danger"></span>
            </div>
            <div class="form-group">
                <label class="labeltext">Last Name</label> <br>
               
                <input size ="50" type="text"  maxlength= "30" class="form-control" name="lastname" placeholder="Enter the last name" />
                <span  class="text-danger"></span>
            </div>
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input size ="50"  maxlength="13" type="text" class="form-control" name ="phone"  placeholder="Enter your phone number"/>
                <span class="text-danger"></span>
            </div>
             <div class="form-group">
                <label class="labeltext"> Description </label> <br>
                <textarea class="resizeText"  name ="description" cols= "50" rows="9" autofocus> </textarea>
                <span  class="text-danger"> </span>
            </div>
